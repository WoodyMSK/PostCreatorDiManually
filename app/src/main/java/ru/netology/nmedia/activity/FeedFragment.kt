        ...
        val adapter = PostsAdapter(object : OnInteractionListener {
            ...
            override fun onLike(post: Post) {
                if (auth.authStateFlow.value.id == 0L) {
                    findNavController().navigate(R.id.action_feedFragment_to_dialogFragment)
                } else {
            ...
            override fun onPicture(post: Post) {
                bundle.putString("ArgPicture", post.attachment!!.url)
                bundle.putString("ArgLikes", post.likes.toString())
                findNavController().navigate(R.id.action_feedFragment_to_pictureViewFragment, bundle)
            }
